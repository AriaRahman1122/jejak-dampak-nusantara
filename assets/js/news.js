...
(function() {
  ...
  function renderNewsGrid() {
    ...
    newsGrid.innerHTML = newsToShow
      .map((news) => `
        <a class="news-card" href="${window.JDN.url(`/berita/detail.html?slug=${encodeURIComponent(news.slug)}`)}">
  ...
  function renderPopularNews() {
    ...
    popularList.innerHTML = popularNews
      .map((news, index) => `
        <a class="popular-news-item" href="${window.JDN.url(`/berita/detail.html?slug=${encodeURIComponent(news.slug)}`)}">
